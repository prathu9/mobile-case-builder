  ...
  return (
    <div className="bg-white">
      <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <div className="max-w-xl">
          ...
          <div className="mt-10 border-t border-zinc-200">
            <div className="mt-10 flex flex-auto flex-col">
              ...
              <p>
                We at Mobile case builder believe that a phone case doesn't only
                need to look good, but also last you for the years to come. We
                offer a 5-year print guarantee: If your case isn't of the
        ...
        <div className="py-10 grid grid-cols-2 gap-x-6 border-t border-zinc-200 text-sm">
            <div>
        ...
        <div className="pt-10 space-y-6 border-t border-zinc-200 text-sm">
